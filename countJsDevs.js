...
// check the values of the contentent and language property on each for the corresponding queries
// filter for the objects that match the conditional and return the number of these objects
const europeanDevCount = list => list.filter(person => person.continent === 'Europe' && person.language === 'JavaScript').length;
